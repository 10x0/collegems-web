...
export default function DeleteModule() {
  ...
  const mutation = useMutation({ mutationFn: deleteModule });
  ...
  return (
    <section className='p-8'>
      ...
      <section className='w-1/2 max-w-1/2 m-auto bg-white p-8 rounded-3xl min-h-[40rem] flex flex-col'>
        <p className='text-2xl'>Do you want to delete this module?</p>
        <section className='grow'>
          <p className='text-5xl font-bold'>
            {location.state.name} - ({location.state?.course?.name})
          </p>
